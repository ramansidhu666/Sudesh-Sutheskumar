    ...
    public partial class Email_Listing : System.Web.UI.Page
    {
        ...
        public string GetPropertyDetails()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.AppendLine("<h2 style='font-weight:bold; font-size:16px;'>Sudesh Sutheskumar for Property ID  " + dt.Rows[0]["MLS"].ToString() + ";</h2>");
                html.AppendLine("<h2 style='font-weight: bold; font-size: 16px;'>Message Received From:</h2>");
                html.AppendLine("<p style='float: left; margin: 0 40px 0 0;'>Phone Number:</p><span style='float:left;'>416-710-8400</span><br/>");
                ...
                html.AppendLine("<p>http://realtorsudesh.com///</p>");
                ...
                //html.AppendLine(" 5010 Steeles Ave. West #11A, Toronto, M9V2B8<br/>Property ID: " + dt.Rows[0]["MLS"].ToString() + "</h2>");
                html.AppendLine("</div>");
                ...
                html.AppendLine("<p>For more information visit <a href='#'>http://realtorsudesh.com//</a> </p></div>");
                html.AppendLine("<div style='float:left; padding-left:12px;'>");
                html.AppendLine("<p style='margin:0px;'>Listed By</p><br/><p>Sudesh Sutheskumar<br/>Sales Representative</p>");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Cell::</p><span style='float:left;'>416-710-8400</span><br/>'");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Website:</p><span style='float:left;'>>http://realtorsudesh.com///</span><br/></div></div>");
                html.AppendLine("<div style='float:left; width:100%;'>");
