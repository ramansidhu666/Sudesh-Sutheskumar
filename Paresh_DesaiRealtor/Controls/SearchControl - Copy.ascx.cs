    ...
    public partial class SearchControl : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                Session["SaleLease"] = Request.QueryString["SaleLease"];
        ...
        void SearchResidentialProperties()
        {
            try
            {
                    ...
                    {
                    if(Session["SaleLease"]!=null)
                    {
 dt = mlsClient.GetResidentialProperties(Session["Municipality"].ToString(), "0", "0", "0", "0", "0", Session["SaleLease"].ToString());
        ...
        void SearchCommercialProperties()
        {
            try
            {
                ...
                
                {
                    if(Session["SaleLease"]!=null)
                    {
 dt = mlsClient.GetAllCommercialProperties(Session["Municipality"].ToString(), "0", "0", "0", "0", Session["SaleLease"].ToString());
        ...
        void SearchCondoProperties()
        {
            try
            {
                ...
                //else if (Session["Municipality"] != null)
                {
                    if(Session["SaleLease"]!=null)
                    {
                        dt = mlsClient.GetProperties_Condo(Session["Municipality"].ToString(), "0", "0", "0", "0", "0", Session["SaleLease"].ToString());
                    }
                    else
                    {
        ...
        void SearchResidentialPropertiesSearch()
        {
            try
            {
...

                {
                    if(Session["SaleLease"]!=null)
                    {
 dt = mlsClient.GetResidentialProperties("0", "0", "0", "0", "0", "0", Session["SaleLease"].ToString());
                    }
                    else
                    {
dt = mlsClient.GetResidentialProperties("0", "0", "0", "0", "0", "0", "0");
        ...
        void SearchCommercialPropertiesSearch()
        {
            try
            {
                ...
                if (Convert.ToString(Session["QueryString"]) == "Commercial")
                {
                    if(Session["SaleLease"]!=null)
                    {
 dt = mlsClient.GetAllCommercialProperties("0", "0", "0", "0", "0", Session["SaleLease"].ToString());
                    }
                    else
                    {
        ...
        void SearchCondoPropertiesSearch()
        {
            try
            {
                ...
                if (Convert.ToString(Session["QueryString"]) == "Condo")
                {
                    if(Session["SaleLease"]!=null)
                    {
 dt = mlsClient.GetProperties_Condo("0", "0", "0", "0", "0", "0", Session["SaleLease"].ToString());
                    }
                    else
                    {
 dt = mlsClient.GetProperties_Condo("0", "0", "0", "0", "0", "0", "0");
