...
namespace Property.Admin
{
    public partial class SiteSettings : System.Web.UI.Page
    {
        ...
        public void bindddl()
        {
            ...
            if(dt.Rows.Count > 0)
            {
                //ddlSales Representative.DataSource = dt;
                //ddlSales Representative.DataValueField = "mls";
                //ddlSales Representative.DataTextField = "ListSales Representative";
               // ddlSales Representative.DataBind();
                //ddlSales Representative.Items.Insert(0, new ListItem("CITYSCAPE REAL ESTATE LTD., Sales Representative", "0"));
            }
        }
        ...
        protected void GetSiteData()
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //txtphone.Text = Convert.ToString(dt.Rows[0]["Sales RepresentativeOnePhone"]);
                    //txtphone2.Text = Convert.ToString(dt.Rows[0]["Sales RepresentativeTwoPhone"]);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < FileColl.Count; i++)
                {
                    ...
                    cmd.Parameters.AddWithValue("@ListSales Representative", "");
